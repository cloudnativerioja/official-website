    ...
    <>
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Los Kubernetes Community Days (KCDs) son eventos organizados por
              la comunidad con el objetivo de reunir usuarios y tecnólogos de
              las comunidades de código libre y nativas en la nube para educar,
              colaborar y conectar los unos con otros.
            </p>
        ...
        <div className="flex items-center justify-center w-full lg:w-1/2">
          <div className="">
            <Image
              src="https://raw.githubusercontent.com/cncf/artwork/7e1e367a5b30b3849953ab5a0133052b31691d5d/other/cncf/icon/color/cncf-icon-color.svg"
              width="616"
              height="617"
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Trusted by <span className="text-cncf">2000+</span> customers
            worldwide
          </div>
